...
public class ContactDiscoveryService extends Application<ContactDiscoveryConfiguration> {
      ...
      throws CertificateException, KeyStoreException, IOException, DecoderException, URISyntaxException, NoSuchAlgorithmException
  {
    ...
    DirectoryPeerManager     directoryPeerManager     = new DirectoryPeerManager(configuration.getDirectoryConfiguration().getMapBuilderUrl(), configuration.getDirectoryConfiguration().getMapBuilderDns(), configuration.getDirectoryConfiguration().getPeerAuthenticationToken(), configuration.getDirectoryConfiguration().isPeerReadEligible());
